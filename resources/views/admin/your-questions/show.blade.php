...
@section('content')
        ...
        <div class="card-body p-4 d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3">
            <div>
                <div class="d-inline-flex align-items-center gap-2 px-3 py-1 rounded-pill mb-2" style="background: #fdf1ec; border: 1px solid #fcebe3;">
                    ...
                    <span class="small fw-semibold text-brand">Thesis Guidance Detail</span>
                </div>
                <h3 class="fw-bold text-dark mb-1">Question & Discussion Thread</h3>
                <p class="text-muted mb-0 small">Review your question details, download draft files, and communicate with your advisor.</p>
            </div>
            <div>
    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm rounded-4 h-100" style="border: 1px solid #f3e4dc !important;">
                <div class="card-header bg-white border-bottom p-4 d-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <div>
                            ...
                            <span class="small text-muted">Submitted on {{ $question->created_at->format('M d, Y \a\t H:i') }}</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body p-4">
                    <div class="mb-4">
                        <label class="form-label text-muted small fw-semibold text-uppercase mb-2">Question Description</label>
                    ...
                    <!-- Attached File Box -->
                    <div>
                        <label class="form-label text-muted small fw-semibold text-uppercase mb-2">Attached Thesis Draft</label>
                        @if ($question->file)
                            <div class="p-3 rounded-3 border bg-white d-flex align-items-center justify-content-between">
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <div>
                                        <span class="fw-semibold text-dark d-block small">Question Document Draft</span>
                                        <span class="text-muted small" style="font-size: 0.75rem;">Click button to download and view attachment</span>
                                    </div>
                                </div>
                        ...
                        @else
                            <div class="p-3 rounded-3 bg-light border text-muted small">
                                <i class="bi bi-info-circle me-1"></i> No file attached to this question.
                            </div>
                        @endif
                    </div>
                </div>
        ...
        <!-- Question Metadata Sidebar (col-lg-4) -->
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm rounded-4 h-100" style="border: 1px solid #f3e4dc !important;">
                <div class="card-header bg-white border-bottom p-4">
                    <h6 class="fw-bold text-dark mb-0"><i class="bi bi-info-circle-fill text-brand me-2"></i> Guidance Info</h6>
                </div>
                ...
                <div class="card-body p-4 d-flex flex-column justify-content-between">
                    <div>
                        <!-- Status Indicator -->
                        <div class="mb-4">
                            <label class="form-label text-muted small fw-semibold text-uppercase mb-1">Guidance Status</label>
                            <div>
                                @if ($question->status == 'revision')
                                    <span class="badge bg-warning-subtle text-warning border border-warning px-3 py-2 rounded-pill fw-bold fs-6">
                        ...
                        <!-- Faculty Advisor -->
                        <div class="mb-4">
                            <label class="form-label text-muted small fw-semibold text-uppercase mb-1">Faculty Advisor</label>
                            <div class="p-3 rounded-3 d-flex align-items-center gap-2" style="background: #fdf1ec; border: 1px solid #fcebe3;">
                                ...
                                <div>
                                    <span class="fw-bold text-dark d-block small">{{ $question->teacher->name ?? 'Advisor' }}</span>
                                    <span class="text-muted small" style="font-size: 0.75rem;">Supervisor</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-0">
                            ...
                            <div class="p-3 rounded-3 border bg-light">
                                <span class="fw-bold text-dark small"><i class="bi bi-mortarboard-fill text-secondary me-1"></i> {{ $question->user->name ?? 'Student' }}</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card border-0 shadow-sm rounded-4" style="border: 1px solid #f3e4dc !important;">
                <div class="card-header bg-white border-bottom p-4 d-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <div>
                            <h5 class="fw-bold text-dark mb-0">Discussion Thread</h5>
                            <span class="small text-muted">Feedback and answers from your advisor</span>
                        </div>
                    </div>
                ...
                <div class="card-body p-4">
                    ...
                    <div class="discussion-timeline mb-4">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mb-3">
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <div>
                                                    ...
                                                    <span class="badge bg-brand text-white small" style="background-color: var(--brand-primary); font-size: 0.7rem;">Faculty Advisor</span>
                                                </div>
                                            </div>
                                        ...
                                        @if ($answer->file)
                                            <div class="pt-3 border-top border-warning-subtle">
                                                <a href="{{ asset('storage/' . $answer->file) }}" class="btn btn-sm btn-hero-primary rounded-pill px-3 py-1" download>
                                                    <i class="bi bi-download me-1"></i> Download Advisor Attachment
                                                </a>
                                            </div>
                                        @endif
                                    </div>
                                    ...
                                    <div class="card-body p-4">
                                        <div class="d-flex align-items-center justify-content-between mb-3">
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <div>
                                                    <span class="fw-bold text-dark d-block">{{ $answer->user->name }}</span>
                                                    <span class="badge bg-secondary text-white small" style="font-size: 0.7rem;">Student</span>
                                                </div>
                                            </div>
                                            <span class="text-muted small"><i class="bi bi-clock me-1"></i> {{ $answer->created_at->diffForHumans() }}</span>
                                        </div>
                                        ...
                                        @if ($answer->file)
                                            <div class="pt-3 border-top">
                                                <a href="{{ asset('storage/' . $answer->file) }}" class="btn btn-sm btn-outline-secondary rounded-pill px-3 py-1" download>
                                                    <i class="bi bi-download me-1 text-brand"></i> Download Attached File
                                                </a>
                                            </div>
                                        @endif
                                    </div>
                        ...
                        @empty
                            <div class="text-center py-5 text-muted bg-light rounded-4 border">
                                ...
                                <p class="mb-0 fw-semibold text-dark">No Feedback Messages Yet</p>
                                <span class="small text-muted">Your advisor has not posted feedback yet. Use the form below to add additional notes or wait for their reply.</span>
                            </div>
                        @endforelse
                    </div>
                    ...
                    <div class="card border-0 rounded-4 p-4 mt-4" style="background: #fdf1ec; border: 1px solid #fcebe3 !important;">
                        <h6 class="fw-bold text-dark mb-3"><i class="bi bi-reply-fill text-brand me-1"></i> Post a Reply / Follow-up</h6>

                        <form action="/admin/your-questions/{{ $question->id }}/answer" method="POST" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" value="{{ $question->id }}" name="question_id">

                            <div class="mb-3">
                                <label for="body" class="form-label fw-semibold text-dark small">Your Message <span class="text-danger">*</span></label>
                                <textarea class="form-control" id="body" name="body" rows="4" placeholder="Type your response or follow-up question here..." required></textarea>
                                @error('body')
                            ...
                            <div class="mb-4">
                                <label for="file" class="form-label fw-semibold text-dark small">Attach Revised File <span class="text-muted fw-normal">(Optional)</span></label>
